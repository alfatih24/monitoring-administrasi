...
<div align="center" class="container">
	...
	<div class="row thumb">
		<form method="post" action="default.php?p=modul/jurnal/kembalikanjurnal__">
			...
			<div class="col-md-2">
				<h1 style="padding-top: 60px;">Atau <br><br> <a href="./" class="btn btn-lg btn-default">Batal</a></h1>
			</div>
			<div class="col-md-5">
